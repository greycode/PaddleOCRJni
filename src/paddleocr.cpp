...
PPOCR::PPOCR(const bool &use_det, const bool &use_cls, const bool &use_angle_cls, const bool &use_rec,
             ...
             const std::string &rec_char_dict_path)
{
  ...
  if (use_rec)
  {
    this->recognizer_ = new CRNNRecognizer(
        ...
        FLAGS_cpu_threads, FLAGS_enable_mkldnn, rec_char_dict_path,
        FLAGS_use_tensorrt, FLAGS_precision, FLAGS_rec_batch_num,
        FLAGS_rec_img_h, FLAGS_rec_img_w);
  }
};
                  ...
                  const bool &use_tensorrt, const std::string &precision)
{
  if (use_det)
  {
    this->detector_ = new DBDetector(
        ...
        cpu_math_library_num_threads, use_mkldnn, max_side_len,
  ...
  if (use_cls && use_angle_cls)
  {
    this->classifier_ = new Classifier(
        ...
        cpu_math_library_num_threads, use_mkldnn, cls_thresh,
  ...
  if (use_rec)
  {
    this->recognizer_ = new CRNNRecognizer(
        ...
        cpu_math_library_num_threads, use_mkldnn, label_path,
